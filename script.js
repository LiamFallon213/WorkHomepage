...
If you have accessed the VPN previously, you will likely just need to download the Cisco AnyConnect software. Please visit the link at the bottom for instructions downloading Cisco AnyConnect and connecting to the VPN. If you have never connected to the MSU VPN - whether Student or Employee - you will need to call the UIT Service Desk, or submit a ticket, and have them add your user account to the VPN Security Group. Once that is done you will be able to follow the link below to download and install the VPN software. [url=http://www.montana.edu/uit/computing/desktop/vpn/index.html]VPN- Secure Remote Access[/url] If you are having issues connecting, please reference the troubleshooting steps below, or contact the UIT Service Desk at 994-1777 or visit us on the first floor of the Renne Library.[quote][u]Cisco AnyConnect VPN Troubleshooting: [/u] Here is the information regarding changing specific settings in the VPN configuration, to help you connect: Ensure you are following [url=http://www.montana.edu/itcenter/computing/desktop/vpn.html]these instructions[/url] for connecting to the MSU VPN.[/quote]
...
